...
function generateNonSmokeTestManualTestingReport(){
	...
	var htmlUrl = Script.resolvePath("https://raw.githubusercontent.com/cozza13/QAtesting/master/qaTest20nstmtr.html")
...
function generateSmokeTestManualTestingReport(){
	...
	Script.setInterval(function() {
		...
		if(Menu.isOptionChecked("localhost ATP Upload + Edit - SUCCESS")){
			MyStats.atpUploadEdit = "**localhost ATP Upload + Edit** SUCCESS";
		} else{
			MyStats.atpUploadEdit = "**localhost ATP Upload + Edit** FAILURE";
		}
